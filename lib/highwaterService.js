...
module.exports = function highwaterService(userApiClient, envConfig) {
  ...
  // var kissClient = require('./kiss/compositeKissClient.js')(
  //   require('./kiss/kissClient.js')(envConfig.apikey, envConfig.metricshost),
  //   require('./kiss/filteredKissClient.js')(
  //     function(user) {
  ...
  var awsClient = require('./dynamo/dynamoDbClient.js')(envConfig.awsConfig, envConfig.awsTableName);

  var highwaterApi = require('./routes/highwaterApi')(userApiClient, awsClient, envConfig.saltDeploy);
